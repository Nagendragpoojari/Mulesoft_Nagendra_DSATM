...
<head>
    ...
    <title>Movie Interest - Nagendra's</title>
...
<body>
    <div>
        <div class="div1">
           <strong><p>Movie Interest - Nagendra's</p></strong>
        </div>

        <div class = "div2">
            <strong><p><i><u>List  of  Movies</u></i></p></strong>
        </div>

        <div class="div2">
            <table style="font-size:25px;color:#56BBF1;" class="table table-striped table-bordered" >
                <thead>
        ...
        <div class="div2">
            ...
            <form action="index.php" name="form" method="post">
                ...
                <div class="form-group">
                    ...
                    <input   style="background-color:#6ab1ef; color:#fff;"type="submit" name="sub"  class="btn btn-light">
                </div>
            </form>   
